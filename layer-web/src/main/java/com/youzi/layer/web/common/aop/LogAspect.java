package com.youzi.layer.web.common.aop;
...
import com.youzi.layer.common.util.IpUtils;
import com.youzi.layer.common.util.JacksonUtils;
...
public class LogAspect {
     ...
     * @editNote：
     */
    @Pointcut("@annotation(com.youzi.layer.web.common.annotation.Log)")
     ...
     * @editNote：
     */
    @Pointcut("execution(* com.youzi.layer.web.controller..*.*(..))")
