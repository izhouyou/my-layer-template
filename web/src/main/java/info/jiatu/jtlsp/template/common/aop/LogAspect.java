package info.jiatu.jtlsp.template.common.aop;
...
public class LogAspect {
     ...
     * @editNote：
     */
    @Pointcut("@annotation(info.jiatu.jtlsp.template.common.annotation.Log)")
     ...
     * @editNote：
     */
    @Pointcut("execution(* info.jiatu.jtlsp.template.controller..*.*(..))")
