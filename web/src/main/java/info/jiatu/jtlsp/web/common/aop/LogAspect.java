package info.jiatu.jtlsp.web.common.aop;
...
public class LogAspect {
     ...
     * @editNote：
     */
    @Pointcut("@annotation(info.jiatu.jtlsp.web.common.annotation.Log)")
     ...
     * @editNote：
     */
    @Pointcut("execution(* info.jiatu.jtlsp.web.controller..*.*(..))")
